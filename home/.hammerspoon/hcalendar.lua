-- copied from https://github.com/ashfinal/awesome-hammerspoon/blob/master/widgets/hcalendar.lua

hcalbgcolor = {red=0,blue=0,green=0,alpha=0.3}
hcaltitlecolor = {red=1,blue=1,green=1,alpha=0.3}
offdaycolor = {red=1,blue=120/255,green=120/255,alpha=1}
...
if not hcaltopleft then
    ...
    hcaltopleft = {(mainRes.w-hcaldaywh[1]*31)/2-20,mainRes.h-161-44}
end
